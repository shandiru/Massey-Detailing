...
export const Services = [
  ...
  {
    subtitle: "Deep Clean & Fabric Seat Wash",
    image: "/c3.jpeg",
    coverage: [
      "Intensive interior deep clean for carpets and upholstery",
      "Removes stains, dirt, trapped dirt and odours",
      "Fabric seat shampoo and extraction wash",
      "Restores freshness and original appearance",
      "Leaves interior hygienic and revitalised",
    ],
  },
];
